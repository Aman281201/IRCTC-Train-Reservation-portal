          ...
          <div class="px-4 py-5 bg-white sm:p-6">
            <div class="grid grid-cols-6 gap-6">
              ...
              <div class="col-span-6 sm:col-span-4">
                <label for="seats" class="block text-sm font-medium text-gray-700">No. of Seats in Train (space separated)</label>
              ...
              <div class="col-span-6">
                <label for="class" class="block text-sm font-medium text-gray-700">Class Code (space separated)</label>
